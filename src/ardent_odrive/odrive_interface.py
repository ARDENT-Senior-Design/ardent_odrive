...
class ODriveInterfaceAPI(object):
    ...
    def connect(self, port=None, axis_0=0, timeout=30):
        ...
        self.axis_0 = self.driver.axis0 if axis_0 == 0 else self.driver.axis1
        self.axis_1  = self.driver.axis1 if axis_0 == 0 else self.driver.axis0
    ...
    def drive(self, left_motor_val, right_motor_val):
        if not self.driver:
            ...
            return
        #try:
        self.axis_1.controller.vel_setpoint = left_motor_val
        self.axis_0.controller.vel_setpoint = -right_motor_val
